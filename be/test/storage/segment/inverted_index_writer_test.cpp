...
TEST_F(InvertedIndexWriterTest, DateTimeV2NanoWrite) {
    TabletColumn field;
    field.set_name("dt");
    field.set_unique_id(0);
    field.set_type(FieldType::OLAP_FIELD_TYPE_DATETIMEV2_NANO);
    field.set_is_nullable(false);

    TabletIndexPB index_meta_pb;
    index_meta_pb.set_index_type(IndexType::INVERTED);
    index_meta_pb.set_index_id(1);
    index_meta_pb.set_index_name("test_datetimev2_nano");
    index_meta_pb.add_col_unique_id(0);
    TabletIndex index_meta;
    index_meta.init_from_pb(index_meta_pb);

    const std::string rowset_id = "test_datetimev2_nano";
