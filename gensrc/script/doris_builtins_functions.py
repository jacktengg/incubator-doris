...
visible_functions = [
    ...
    [['murmur_hash3_32'], 'INT', ['STRING', '...'],
        '_ZN5doris13HashFunctions15murmur_hash3_32EPN9doris_udf15FunctionContextEiPKNS1_9StringValE',
        '', '', 'vec', ''],
    [['murmur_hash3_32_unsigned'], 'BIGINT', ['VARCHAR', '...'],
        '_ZN5doris13HashFunctions24murmur_hash3_32_unsignedEPN9doris_udf15FunctionContextEiPKNS1_9StringValE',
        '', '', 'vec', ''],
    [['murmur_hash3_32_unsigned'], 'BIGINT', ['STRING', '...'],
        '_ZN5doris13HashFunctions24murmur_hash3_32_unsignedEPN9doris_udf15FunctionContextEiPKNS1_9StringValE',
        '', '', 'vec', ''],
    ...
    [['murmur_hash3_64'], 'BIGINT', ['STRING', '...'],
        '_ZN5doris13HashFunctions15murmur_hash3_64EPN9doris_udf15FunctionContextEiPKNS1_9StringValE',
        '', '', 'vec', ''],
    [['murmur_hash3_64_unsigned'], 'LARGEINT', ['VARCHAR', '...'],
        '_ZN5doris13HashFunctions24murmur_hash3_64_unsignedEPN9doris_udf15FunctionContextEiPKNS1_9StringValE',
        '', '', 'vec', ''],
    [['murmur_hash3_64_unsigned'], 'LARGEINT', ['STRING', '...'],
        '_ZN5doris13HashFunctions24murmur_hash3_64_unsignedEPN9doris_udf15FunctionContextEiPKNS1_9StringValE',
        '', '', 'vec', ''],
