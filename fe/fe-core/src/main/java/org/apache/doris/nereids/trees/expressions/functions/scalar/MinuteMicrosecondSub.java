...
/**
 * ScalarFunction 'minute_microsecond_sub'.
 */
public class MinuteMicrosecondSub extends ScalarFunction
    ...
    public MinuteMicrosecondSub(Expression arg0, Expression arg1) {
        super("minute_microsecond_sub", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private MinuteMicrosecondSub(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public MinuteMicrosecondSub withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new MinuteMicrosecondSub(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitMinuteMicrosecondSub(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new MinuteMicrosecondSub(literal, child(1));
    }
