...
/**
 * ScalarFunction 'day_microsecond_sub'.
 */
public class DayMicrosecondSub extends ScalarFunction
    ...
    public DayMicrosecondSub(Expression arg0, Expression arg1) {
        super("day_microsecond_sub", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private DayMicrosecondSub(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public DayMicrosecondSub withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new DayMicrosecondSub(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitDayMicrosecondSub(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new DayMicrosecondSub(literal, child(1));
    }
