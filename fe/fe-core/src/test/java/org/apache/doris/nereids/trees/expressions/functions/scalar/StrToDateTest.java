...
class StrToDateTest {
    ...
    void testComputeSignatureWithFoldableFormat() {
        ...
        Assertions.assertEquals(DateTimeV2Type.MAX_MICROSECOND, microsecondSignature.returnType);
        Assertions.assertEquals(DateTimeV2Type.MAX_MICROSECOND, nonConstantSignature.returnType);
    }
}
