...
class DateTimeMicrosecondFunctionTest {
    ...
    void testDateTimeV2MicrosecondArithmeticMinimumScale() {
        assertDateTimeV2Scale(0, DateTimeV2Type.MAX_MICROSECOND_SCALE);
        assertDateTimeV2Scale(6, DateTimeV2Type.MAX_MICROSECOND_SCALE);
        assertDateTimeV2Scale(9, DateTimeV2Type.MAX_SCALE);
    }
    ...
    void testImplicitStringDateTimeFunctionsKeepMicrosecondPrecision() {
        ...
        Assertions.assertEquals(DateTimeV2Type.MAX_MICROSECOND, timeSignature.getArgType(0));
    ...
    private void assertDateTimeV2MicrosecondSignature(ScalarFunction function, int argumentIndex) {
        FunctionSignature signature = function.getSignature();
        Assertions.assertEquals(DateTimeV2Type.MAX_MICROSECOND,
