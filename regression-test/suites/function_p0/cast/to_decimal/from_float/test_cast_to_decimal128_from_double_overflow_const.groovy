...
suite("test_cast_to_decimal128_from_double_overflow_const") {
    ...
    def test_cast_to_decimal128v3_38_0_from_float64_overflow_vals = [("1.1e+38"),("-1.1e+38"),("inf"),("-inf"),("nan"),
        ("-nan")]
    ...
    def test_cast_to_decimal128v3_38_19_from_float64_overflow_vals = [("1.1e+19"),("-1.1e+19"),("inf"),("-inf"),("nan"),
        ("-nan")]
    sql "set enable_strict_cast=true;"
    ...
    def test_cast_to_decimal128v3_38_37_from_float64_overflow_vals = [("10"),("-10"),("inf"),("-inf"),("nan"),
        ("-nan")]
    sql "set enable_strict_cast=true;"
