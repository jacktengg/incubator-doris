...
suite("test_cast_to_decimal256_from_float_const") {
    ...
    def const_sql_0 = """select cast(cast("0.04" as float) as decimalv3(76, 0));"""
    qt_sql_0_strict "{const_sql_0}"
    testFoldConst("${const_sql_0}")
    def const_sql_1 = """select cast(cast("1.04" as float) as decimalv3(76, 0));"""
    qt_sql_1_strict "{const_sql_1}"
    testFoldConst("${const_sql_1}")
    def const_sql_2 = """select cast(cast("9.04" as float) as decimalv3(76, 0));"""
    qt_sql_2_strict "{const_sql_2}"
    testFoldConst("${const_sql_2}")
    def const_sql_3 = """select cast(cast("0.05" as float) as decimalv3(76, 0));"""
    qt_sql_3_strict "{const_sql_3}"
    testFoldConst("${const_sql_3}")
    def const_sql_4 = """select cast(cast("1.05" as float) as decimalv3(76, 0));"""
    qt_sql_4_strict "{const_sql_4}"
    testFoldConst("${const_sql_4}")
    def const_sql_5 = """select cast(cast("9.05" as float) as decimalv3(76, 0));"""
    qt_sql_5_strict "{const_sql_5}"
    testFoldConst("${const_sql_5}")
    def const_sql_6 = """select cast(cast("-0.04" as float) as decimalv3(76, 0));"""
    qt_sql_6_strict "{const_sql_6}"
    testFoldConst("${const_sql_6}")
    def const_sql_7 = """select cast(cast("-1.04" as float) as decimalv3(76, 0));"""
    qt_sql_7_strict "{const_sql_7}"
    testFoldConst("${const_sql_7}")
    def const_sql_8 = """select cast(cast("-9.04" as float) as decimalv3(76, 0));"""
    qt_sql_8_strict "{const_sql_8}"
    testFoldConst("${const_sql_8}")
    def const_sql_9 = """select cast(cast("-0.05" as float) as decimalv3(76, 0));"""
    qt_sql_9_strict "{const_sql_9}"
    testFoldConst("${const_sql_9}")
    def const_sql_10 = """select cast(cast("-1.05" as float) as decimalv3(76, 0));"""
    qt_sql_10_strict "{const_sql_10}"
    testFoldConst("${const_sql_10}")
    def const_sql_11 = """select cast(cast("-9.05" as float) as decimalv3(76, 0));"""
    ...
    testFoldConst("${const_sql_11}")
    sql "set enable_strict_cast=true;"
    def const_sql_12 = """select cast(cast("4e-39" as float) as decimalv3(76, 38));"""
    qt_sql_12_strict "{const_sql_12}"
    testFoldConst("${const_sql_12}")
    def const_sql_13 = """select cast(cast("1.4e-38" as float) as decimalv3(76, 38));"""
    qt_sql_13_strict "{const_sql_13}"
    testFoldConst("${const_sql_13}")
    def const_sql_14 = """select cast(cast("9.4e-38" as float) as decimalv3(76, 38));"""
    qt_sql_14_strict "{const_sql_14}"
    testFoldConst("${const_sql_14}")
    def const_sql_15 = """select cast(cast("0.1" as float) as decimalv3(76, 38));"""
    qt_sql_15_strict "{const_sql_15}"
    testFoldConst("${const_sql_15}")
    def const_sql_16 = """select cast(cast("0.9" as float) as decimalv3(76, 38));"""
    qt_sql_16_strict "{const_sql_16}"
    testFoldConst("${const_sql_16}")
    def const_sql_17 = """select cast(cast("0.9" as float) as decimalv3(76, 38));"""
    qt_sql_17_strict "{const_sql_17}"
    testFoldConst("${const_sql_17}")
    def const_sql_18 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_18_strict "{const_sql_18}"
    testFoldConst("${const_sql_18}")
    def const_sql_19 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_19_strict "{const_sql_19}"
    testFoldConst("${const_sql_19}")
    def const_sql_20 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_20_strict "{const_sql_20}"
    testFoldConst("${const_sql_20}")
    def const_sql_21 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_21_strict "{const_sql_21}"
    testFoldConst("${const_sql_21}")
    def const_sql_22 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_22_strict "{const_sql_22}"
    testFoldConst("${const_sql_22}")
    def const_sql_23 = """select cast(cast("1.1" as float) as decimalv3(76, 38));"""
    qt_sql_23_strict "{const_sql_23}"
    testFoldConst("${const_sql_23}")
    def const_sql_24 = """select cast(cast("5e-39" as float) as decimalv3(76, 38));"""
    qt_sql_24_strict "{const_sql_24}"
    testFoldConst("${const_sql_24}")
    def const_sql_25 = """select cast(cast("1.5e-38" as float) as decimalv3(76, 38));"""
    qt_sql_25_strict "{const_sql_25}"
    testFoldConst("${const_sql_25}")
    def const_sql_26 = """select cast(cast("9.5e-38" as float) as decimalv3(76, 38));"""
    qt_sql_26_strict "{const_sql_26}"
    testFoldConst("${const_sql_26}")
    def const_sql_27 = """select cast(cast("0.1" as float) as decimalv3(76, 38));"""
    qt_sql_27_strict "{const_sql_27}"
    testFoldConst("${const_sql_27}")
    def const_sql_28 = """select cast(cast("0.9" as float) as decimalv3(76, 38));"""
    qt_sql_28_strict "{const_sql_28}"
    testFoldConst("${const_sql_28}")
    def const_sql_29 = """select cast(cast("0.9" as float) as decimalv3(76, 38));"""
    qt_sql_29_strict "{const_sql_29}"
    testFoldConst("${const_sql_29}")
    def const_sql_30 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_30_strict "{const_sql_30}"
    testFoldConst("${const_sql_30}")
    def const_sql_31 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_31_strict "{const_sql_31}"
    testFoldConst("${const_sql_31}")
    def const_sql_32 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_32_strict "{const_sql_32}"
    testFoldConst("${const_sql_32}")
    def const_sql_33 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_33_strict "{const_sql_33}"
    testFoldConst("${const_sql_33}")
    def const_sql_34 = """select cast(cast("1" as float) as decimalv3(76, 38));"""
    qt_sql_34_strict "{const_sql_34}"
    testFoldConst("${const_sql_34}")
    def const_sql_35 = """select cast(cast("1.1" as float) as decimalv3(76, 38));"""
    qt_sql_35_strict "{const_sql_35}"
    testFoldConst("${const_sql_35}")
    def const_sql_36 = """select cast(cast("-4e-39" as float) as decimalv3(76, 38));"""
    qt_sql_36_strict "{const_sql_36}"
    testFoldConst("${const_sql_36}")
    def const_sql_37 = """select cast(cast("-1.4e-38" as float) as decimalv3(76, 38));"""
    qt_sql_37_strict "{const_sql_37}"
    testFoldConst("${const_sql_37}")
    def const_sql_38 = """select cast(cast("-9.4e-38" as float) as decimalv3(76, 38));"""
    qt_sql_38_strict "{const_sql_38}"
    testFoldConst("${const_sql_38}")
    def const_sql_39 = """select cast(cast("-0.1" as float) as decimalv3(76, 38));"""
    qt_sql_39_strict "{const_sql_39}"
    testFoldConst("${const_sql_39}")
    def const_sql_40 = """select cast(cast("-0.9" as float) as decimalv3(76, 38));"""
    qt_sql_40_strict "{const_sql_40}"
    testFoldConst("${const_sql_40}")
    def const_sql_41 = """select cast(cast("-0.9" as float) as decimalv3(76, 38));"""
    qt_sql_41_strict "{const_sql_41}"
    testFoldConst("${const_sql_41}")
    def const_sql_42 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_42_strict "{const_sql_42}"
    testFoldConst("${const_sql_42}")
    def const_sql_43 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_43_strict "{const_sql_43}"
    testFoldConst("${const_sql_43}")
    def const_sql_44 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_44_strict "{const_sql_44}"
    testFoldConst("${const_sql_44}")
    def const_sql_45 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_45_strict "{const_sql_45}"
    testFoldConst("${const_sql_45}")
    def const_sql_46 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_46_strict "{const_sql_46}"
    testFoldConst("${const_sql_46}")
    def const_sql_47 = """select cast(cast("-1.1" as float) as decimalv3(76, 38));"""
    qt_sql_47_strict "{const_sql_47}"
    testFoldConst("${const_sql_47}")
    def const_sql_48 = """select cast(cast("-5e-39" as float) as decimalv3(76, 38));"""
    qt_sql_48_strict "{const_sql_48}"
    testFoldConst("${const_sql_48}")
    def const_sql_49 = """select cast(cast("-1.5e-38" as float) as decimalv3(76, 38));"""
    qt_sql_49_strict "{const_sql_49}"
    testFoldConst("${const_sql_49}")
    def const_sql_50 = """select cast(cast("-9.5e-38" as float) as decimalv3(76, 38));"""
    qt_sql_50_strict "{const_sql_50}"
    testFoldConst("${const_sql_50}")
    def const_sql_51 = """select cast(cast("-0.1" as float) as decimalv3(76, 38));"""
    qt_sql_51_strict "{const_sql_51}"
    testFoldConst("${const_sql_51}")
    def const_sql_52 = """select cast(cast("-0.9" as float) as decimalv3(76, 38));"""
    qt_sql_52_strict "{const_sql_52}"
    testFoldConst("${const_sql_52}")
    def const_sql_53 = """select cast(cast("-0.9" as float) as decimalv3(76, 38));"""
    qt_sql_53_strict "{const_sql_53}"
    testFoldConst("${const_sql_53}")
    def const_sql_54 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_54_strict "{const_sql_54}"
    testFoldConst("${const_sql_54}")
    def const_sql_55 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_55_strict "{const_sql_55}"
    testFoldConst("${const_sql_55}")
    def const_sql_56 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_56_strict "{const_sql_56}"
    testFoldConst("${const_sql_56}")
    def const_sql_57 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_57_strict "{const_sql_57}"
    testFoldConst("${const_sql_57}")
    def const_sql_58 = """select cast(cast("-1" as float) as decimalv3(76, 38));"""
    qt_sql_58_strict "{const_sql_58}"
    testFoldConst("${const_sql_58}")
    def const_sql_59 = """select cast(cast("-1.1" as float) as decimalv3(76, 38));"""
    ...
    testFoldConst("${const_sql_59}")
    sql "set enable_strict_cast=true;"
    def const_sql_60 = """select cast(cast("0" as float) as decimalv3(76, 75));"""
    qt_sql_60_strict "{const_sql_60}"
    testFoldConst("${const_sql_60}")
    def const_sql_61 = """select cast(cast("0" as float) as decimalv3(76, 75));"""
    qt_sql_61_strict "{const_sql_61}"
    testFoldConst("${const_sql_61}")
    def const_sql_62 = """select cast(cast("0" as float) as decimalv3(76, 75));"""
    qt_sql_62_strict "{const_sql_62}"
    testFoldConst("${const_sql_62}")
    def const_sql_63 = """select cast(cast("0" as float) as decimalv3(76, 75));"""
    qt_sql_63_strict "{const_sql_63}"
    testFoldConst("${const_sql_63}")
    def const_sql_64 = """select cast(cast("0" as float) as decimalv3(76, 75));"""
    qt_sql_64_strict "{const_sql_64}"
    testFoldConst("${const_sql_64}")
    def const_sql_65 = """select cast(cast("0" as float) as decimalv3(76, 75));"""
    qt_sql_65_strict "{const_sql_65}"
    testFoldConst("${const_sql_65}")
    def const_sql_66 = """select cast(cast("-0" as float) as decimalv3(76, 75));"""
    qt_sql_66_strict "{const_sql_66}"
    testFoldConst("${const_sql_66}")
    def const_sql_67 = """select cast(cast("-0" as float) as decimalv3(76, 75));"""
    qt_sql_67_strict "{const_sql_67}"
    testFoldConst("${const_sql_67}")
    def const_sql_68 = """select cast(cast("-0" as float) as decimalv3(76, 75));"""
    qt_sql_68_strict "{const_sql_68}"
    testFoldConst("${const_sql_68}")
    def const_sql_69 = """select cast(cast("-0" as float) as decimalv3(76, 75));"""
    qt_sql_69_strict "{const_sql_69}"
    testFoldConst("${const_sql_69}")
    def const_sql_70 = """select cast(cast("-0" as float) as decimalv3(76, 75));"""
    qt_sql_70_strict "{const_sql_70}"
    testFoldConst("${const_sql_70}")
    def const_sql_71 = """select cast(cast("-0" as float) as decimalv3(76, 75));"""
