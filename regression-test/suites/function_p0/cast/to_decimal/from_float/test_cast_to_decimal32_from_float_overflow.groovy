...
suite("test_cast_to_decimal32_from_float_overflow") {
    ...
    sql """insert into test_cast_to_decimal32_9_0_from_float32_overflow values (0, "1100000000"),(1, "-1100000000"),(2, "inf"),(3, "-inf"),(4, "nan"),
      (5, "-nan");
    """
    ...
    def test_cast_to_decimal32_9_0_from_float32_overflow_data_end_index = 6
    ...
    sql """insert into test_cast_to_decimal32_9_3_from_float32_overflow values (6, "1099999"),(7, "-1099999"),(8, "inf"),(9, "-inf"),(10, "nan"),
      (11, "-nan");
    """

    sql "set enable_strict_cast=true;"

    def test_cast_to_decimal32_9_3_from_float32_overflow_data_start_index = 6
    def test_cast_to_decimal32_9_3_from_float32_overflow_data_end_index = 12
    ...
    sql """insert into test_cast_to_decimal32_9_8_from_float32_overflow values (12, "10"),(13, "-10"),(14, "inf"),(15, "-inf"),(16, "nan"),
      (17, "-nan");
    """

    sql "set enable_strict_cast=true;"

    def test_cast_to_decimal32_9_8_from_float32_overflow_data_start_index = 12
    def test_cast_to_decimal32_9_8_from_float32_overflow_data_end_index = 18
