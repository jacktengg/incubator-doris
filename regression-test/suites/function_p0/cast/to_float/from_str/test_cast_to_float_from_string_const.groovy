...
suite("test_cast_to_float_from_string_const") {
    ...
    def const_sql_0_102 = """select "-NAN", cast("-NAN" as float);"""
    ...
    def const_sql_0_105 = """select "-INF", cast("-INF" as float);"""
    ...
    def const_sql_0_108 = """select "-INFINITY", cast("-INFINITY" as float);"""
    qt_sql_0_108_strict "${const_sql_0_108}"
    testFoldConst("${const_sql_0_108}")
    def const_sql_0_109 = """select "-3.4028235e+38", cast("-3.4028235e+38" as float);"""
    qt_sql_0_109_strict "${const_sql_0_109}"
    testFoldConst("${const_sql_0_109}")
    def const_sql_0_110 = """select "-1.1754944e-38", cast("-1.1754944e-38" as float);"""
    qt_sql_0_110_strict "${const_sql_0_110}"
    testFoldConst("${const_sql_0_110}")
    def const_sql_0_111 = """select "-1e-45", cast("-1e-45" as float);"""
